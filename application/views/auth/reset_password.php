...
<head>
    ...
    <title>Reset Password - Goldpay</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0 w-100">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center p-0">
                                    <img src="/assets/images/pages/reset-password.png" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="post">
                                                    ...
                                                    <fieldset class="form-label-group">
                                                        <input type="password" class="form-control" id="user-confirm-password" placeholder="Confirm Password" name="password2" required>
